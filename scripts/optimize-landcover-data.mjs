...
const filePath = new URL("../public/warsaw-landcover.json", import.meta.url);
const source = JSON.parse(await fs.readFile(filePath, "utf8"));
const allowedTags = new Set(["amenity", "landuse", "leisure", "natural", "water"]);
...
console.info(`Zapisano ${elements.length} obszarów terenu.`);
